...
public class RedisJava {
    public static void main(String[] args) {
        ...
        JedisShardInfo jsi = new JedisShardInfo("localhost", 6379);
        shards.add(jsi);
        ShardedJedis shardedJedis = new ShardedJedis(shards);

        RedisJava redisJava = new RedisJava();
//        redisJava.KeyOperate(jedis, shardedJedis);
//        redisJava.StringOperate(jedis, shardedJedis);
        redisJava.ListOperate(jedis, shardedJedis);
//        redisJava.HashOperate(jedis, shardedJedis);
//        redisJava.SetOperate(jedis, shardedJedis);
//        redisJava.SortedSetOperate(jedis, shardedJedis);
    }

    private void KeyOperate(Jedis jedis, ShardedJedis shardedJedis) {
    ...
    private void StringOperate(Jedis jedis, ShardedJedis shardedJedis) {
    ...
    private void ListOperate(Jedis jedis, ShardedJedis shardedJedis) {
    ...
    private void SetOperate(Jedis jedis, ShardedJedis shardedJedis) {
    ...
    private void SortedSetOperate(Jedis jedis, ShardedJedis shardedJedis) {
    ...
    private void HashOperate(Jedis jedis, ShardedJedis shardedJedis) {
